...
public class FishinRegistryDunajecKroscienkoController {
    ...
    @PutMapping(value = "updateDunajecKroscienkoRegistry")
    public DunajecKroscienkoRegistryDto updateDunajecKroscienkoRegistry(@RequestBody DunajecKroscienkoRegistryDto dunajecKroscienkoRegistryDto) {
        return fishingRegistryDunajecKroscienkoMapper.mapToDunajecKroscienkoDto(dbServiceFishingRegistryDunajecKroscienkoRepository.updateFish(fishingRegistryDunajecKroscienkoMapper.mapToDunajecKroscienko(dunajecKroscienkoRegistryDto)));
    }
}
